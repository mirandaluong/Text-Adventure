...
show that he wasn't just a scary ogre, and had many layers like
...
if user_input == "start":
    ...
    if user_input == "take a nap":
        ...
        if user_input == "yes":
            ...
            user_input = input()
            if user_input == "fight":
                print("You have defeated the dragon and saved the day by rescuing Princess Fiona. She has fallen madly in love with you and both of you have decided to get married and you lived Happily Ever After...")
            elif user_input == "run away":
                print("You couldn't escape and got burned alive by the dragon:(")
                print("Game Over.") # finished the story writing what happens
